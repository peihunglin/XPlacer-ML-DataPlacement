...
do
echo $m $i $j $k
nvcc  -O2 -Xptxas -v --gpu-architecture=compute_70 --gpu-code=compute_70 gaussian_adapt.cu ../../cuda-adapter/adapter.o -o gaussian_adapt $INCLUDE_OPT $LINK_FLAGS -Dadv1=$i -Dadv2=$j -Dadv3=$k 
